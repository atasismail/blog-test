...
<head>
    ...
    <link href="{{ asset('cdn/css/dashboard.css') }}" rel="stylesheet">
...
<body>
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        ...
        <div class="navbar-nav">
            <div class="nav-item text-nowrap">
                <a class="nav-link px-3" href="{{ route('logout') }}">Güvenli Çıkış</a>
            </div>
        </div>
    </header>
        ...
        <div class="position-sticky pt-3">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="{{ route('takip.index') }}">
                        <span data-feather="file"></span>
                        Takip Eden Mail Adresler
                    </a>
                </li>
            </ul>
        </div>
    ...
    <script src="{{ asset('cdn/js/dashboard.js') }}"></script>
